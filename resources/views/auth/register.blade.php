                                    ...
                                    <div class="pt-0">
                                        <form method="POST" action="{{ route('register') }}" class="my-4">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control" name="password_confirmation" type="password" id="password_confirmation" required="" placeholder="Enter your confirm password">
                                            </div>
                                        ...
                                        <div class="text-center text-muted mb-4">
                                            <p class="mb-0">Already have an account ?<a class='text-primary ms-2 fw-medium' href='{{ route('login') }}'>Sing In</a></p>
                                        </div>
